...
const ChangeText = ({ content , element, onClose, onSave, onDelete, setData }) => {
    ...
    if (validateTitle(title)) {
      ...
      if(element == "name"){
        setData((prevData) => ({
          ...
          name: {text: title , style : style}  // Update only the background image
        }));
      }else{
        setData((prevData) => ({
          ...prevData,  // Preserve the previous state
          title: {text: title , style : style}  // Update only the background image
        }));
      }
